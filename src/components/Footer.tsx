  ...
  return (
    <div className='dark'>
        <footer className='bg-zinc-50 dark:bg-black text-zinc-700 dark:text-zinc-400 text-sm z-20'>
            <hr className="w-full border-none h-px bg-gradient-to-r from-black/0 via-black/10 to-black/0 dark:from-white/0 dark:via-white/25 dark:to-white/0 "/>
            <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 py-24 flex flex-col sm:flex-row gap-10 justify-between'>
                ...
                <Image src="/logo.png" width={25} height={25} alt="logo"></Image>
                <span className='font-bold text-2xl text-white'>Net Working</span>
            </a>
                    <p className="leading-relaxed my-6">Copyright © {new Date().getFullYear()} Supernova Inc.</p>
